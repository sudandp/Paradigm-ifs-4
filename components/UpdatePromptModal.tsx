    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-gray-900/80 backdrop-blur-sm p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-sm w-full overflow-hidden flex flex-col items-center p-6 text-center animate-in fade-in zoom-in duration-300">
        ...
        <p className="text-gray-600 mb-6">
          A new version ({updateInfo.latestVersionName}) is available. Update now for the latest features, or do it later from the Play Store.
        </p>
        ...
        <button
          ...
          className="w-full bg-white hover:bg-emerald-50 text-emerald-700 border border-emerald-200 font-semibold py-3 px-6 rounded-xl transition-colors shadow-sm flex items-center justify-center gap-2 mb-3"
        >
