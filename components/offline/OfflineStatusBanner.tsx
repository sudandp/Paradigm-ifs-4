...
export const OfflineStatusBanner: React.FC = () => {
  ...
  if (totalActionNeeded > 0) {
    return (
      <div className="bg-amber-500/15 border-b border-amber-500/30 px-4 py-2 text-amber-200 text-xs sm:text-sm font-medium flex items-center justify-between shadow-sm backdrop-blur-md sticky top-0 z-40">
        ...
        <div className="flex items-center gap-2 flex-shrink-0 ml-3">
          <button
            ...
            className="px-2.5 py-1 bg-amber-500/20 hover:bg-amber-500/30 text-amber-300 rounded border border-amber-500/40 text-xs font-semibold transition-colors shadow-xs"
          >
            Review & Fix
          </button>
        </div>
  ...
  if (summary.syncing > 0) {
    return (
      <div className="bg-blue-500/15 border-b border-blue-500/30 px-4 py-1.5 text-blue-200 text-xs sm:text-sm font-medium flex items-center justify-between backdrop-blur-md sticky top-0 z-40">
  ...
  if (!isOnline || !isReachableState) {
    return (
      <div className="bg-emerald-950/80 border-b border-emerald-800/40 px-4 py-2 text-emerald-300 text-xs sm:text-sm font-medium flex items-center justify-between backdrop-blur-md sticky top-0 z-40">
        <div className="flex items-center gap-2">
        ...
        {totalQueued > 0 && (
          <button
            type="button"
            onClick={() => navigate('/sync-review')}
            className="text-xs text-emerald-400 hover:text-emerald-300 underline font-semibold flex-shrink-0 ml-2"
          >
            View Queue
          </button>
        )}
  ...
  if (totalQueued > 0) {
    return (
      <div className="bg-emerald-900/30 border-b border-emerald-700/30 px-4 py-1.5 text-emerald-200 text-xs sm:text-sm font-medium flex items-center justify-between backdrop-blur-md sticky top-0 z-40">
        <div className="flex items-center gap-2">
        ...
        <button
          type="button"
          onClick={() => syncNow()}
          className="px-2.5 py-0.5 bg-emerald-700/40 hover:bg-emerald-700/60 text-emerald-200 rounded text-xs font-semibold transition-colors border border-emerald-600/40 flex items-center gap-1.5"
        >
