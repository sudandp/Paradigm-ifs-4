    ...
    return (
        <header
            className={`relative transition-all duration-300 flex-shrink-0 ${
                isMobile 
                ? 'bg-transparent' 
                : 'bg-white border-b border-gray-200/60 desktop-scaled'
            }`}
        >
                                ...
                                <div className="relative" ref={userMenuRef}>
                                    ...
                                    >
                                        ...
                                        <div className="text-left hidden sm:block overflow-hidden ml-1">
                                            <span className="text-sm font-semibold truncate block whitespace-nowrap text-gray-900 leading-tight">{user.name}</span>
                                            <span className="text-[10px] truncate block whitespace-nowrap uppercase tracking-wider text-gray-500 leading-none mt-0.5">{getRoleName(user.role)}</span>
                                        </div>
