...
export const allNavLinks: NavLinkConfig[] = [
    ...
    { to: '/admin/site-routing', label: 'Site Responsibility Matrix', icon: Layers, permission: 'manage_sites', category: 'Site Management' },
    ...
    { to: '/admin/site-routing', label: 'Site Routing & Matrix', icon: Layers, permission: 'manage_users', category: 'Security & Roles' },
    { to: '/admin/user-home-details', label: 'User Home Details', icon: Home, permission: 'manage_users', category: 'Security & Roles' },
    ...
    { to: '/admin/workflow-chart', label: '2D Workflow Chart', icon: Network, permission: 'manage_approval_workflow', category: 'Security & Roles' },
