    ...
    <div className="relative">
      ...
      {isPassword && (
        <button
          ...
          className="absolute right-3 top-1/2 -translate-y-1/2 p-2 text-muted hover:text-emerald-500 transition-all focus:outline-none btn-icon !bg-transparent !border-none !shadow-none"
          tabIndex={-1}
        >
