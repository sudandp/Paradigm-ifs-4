...
const Input = React.forwardRef<HTMLInputElement, InputProps>(({ 
  ...
  autoCapitalizeCustom = true, forceUppercase = false, pattern, onComplete, passwordToggleClassName, ...props 
}, ref) => {
    ...
    <div className="relative">
      ...
      {isPassword && (
        <button
          ...
          className={`absolute right-3 top-1/2 -translate-y-1/2 p-2 transition-all focus:outline-none btn-icon !bg-transparent !border-none !shadow-none password-toggle ${passwordToggleClassName || 'text-gray-400 hover:text-emerald-600 dark:text-white/40 dark:hover:text-emerald-400'}`}
          tabIndex={-1}
        >
