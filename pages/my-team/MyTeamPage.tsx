        ...
        <div className="space-y-2">
          <div className="flex justify-between items-center">
            <h2 className="text-xs font-black text-white uppercase tracking-wider flex items-center gap-2">
              <MapPin className="w-3.5 h-3.5 text-[#44D62C]" />
              Live Team Map
            </h2>
            <span className="text-[10px] text-gray-400 font-semibold bg-[#092c19] px-2.5 py-0.5 rounded-full border border-[#134426]">
