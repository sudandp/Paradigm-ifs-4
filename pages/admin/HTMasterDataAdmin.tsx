  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 p-6 lg:p-10 font-sans">
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 rounded-3xl p-6 shadow-sm mb-6 transition-all">
        {/* Tier 1: Title, Metrics & Primary Actions */}
        <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-5 pb-5 border-b border-slate-100 dark:border-slate-800/80">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-2 flex-wrap pl-0.5">
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-xl text-xs font-extrabold bg-emerald-50 dark:bg-emerald-950/50 text-emerald-700 dark:text-emerald-300 border border-emerald-200/60 dark:border-emerald-800/60">
              ...
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-xl text-xs font-extrabold bg-amber-50 dark:bg-amber-950/50 text-amber-700 dark:text-amber-300 border border-amber-200/60 dark:border-amber-800/60">
                ...
                {options.length} Dropdown Choices
              </span>

              <div className="hidden md:flex items-center gap-2 ml-2 pl-2 border-l border-slate-200 dark:border-slate-700 text-xs">
                <Link
                  to="/operations/ppm-calendar"
                  className="text-slate-500 hover:text-emerald-600 dark:text-slate-400 dark:hover:text-emerald-400 font-bold flex items-center gap-1 transition-colors"
                >
                  <Calendar className="w-3.5 h-3.5" /> PPM Calendar
                </Link>
                ...
                <Link
                  ...
                  className="text-slate-500 hover:text-emerald-600 dark:text-slate-400 dark:hover:text-emerald-400 font-bold flex items-center gap-1 transition-colors"
                >
                  <QrCode className="w-3.5 h-3.5" /> Asset QR Tags
                </Link>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2.5 flex-wrap">
            {/* View Switcher */}
            <div className="flex items-center bg-slate-100 dark:bg-slate-800/90 p-1 rounded-2xl border border-slate-200/80 dark:border-slate-700 text-xs font-bold shadow-2xs">
              <button
            ...
            <div className="flex items-center gap-1.5">
              ...
              >
                <BookOpen className="w-3.5 h-3.5 text-indigo-500" /> Guide
              </button>

              <button
                onClick={() => setShowBulkUploadModal(true)}
                title="Bulk Upload choices from Excel/CSV"
                className="px-3.5 py-2 bg-indigo-50 hover:bg-indigo-100 dark:bg-indigo-950/60 dark:hover:bg-indigo-900/60 text-indigo-700 dark:text-indigo-300 border border-indigo-200 dark:border-indigo-800 rounded-2xl text-xs font-bold transition-all flex items-center gap-1.5 shadow-2xs cursor-pointer"
              >
                <Upload className="w-3.5 h-3.5 text-indigo-600 dark:text-indigo-400" /> Bulk Upload
              </button>

              <button
                onClick={handleResetDefaults}
                title="Reset active category defaults"
                className="p-2 border border-slate-200 dark:border-slate-700 rounded-2xl text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors shadow-2xs cursor-pointer"
              >
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-2xl text-xs font-bold shadow-md shadow-emerald-600/20 transition-all flex items-center gap-1.5 cursor-pointer"
              >
        ...
        <div className="mt-4 pt-2 flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          {/* Right Action: Delete active category */}
