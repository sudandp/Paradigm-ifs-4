...
export type Permission =
  ...
  | 'view_kiosk_monitoring'
  | 'manage_linked_devices'
  | 'manage_gate_registration'
  | 'view_gate_logs'
  | 'manage_gate_kiosk'
  ...
  | 'view_operations'
  | 'view_referrals'
  | 'view_candidate_referrals'
  | 'view_business_referrals'
  | 'view_my_referrals'
  ...
  | 'view_ht_yard_audits'
  | 'view_ppm_audits'
  | 'view_audit_change_log'
  | 'view_site_audit_report'
  | 'view_ppm_audit_report'
