...
async function setExact35() {
    const userId = '216d264d-b20b-45a1-91b5-09cb47c781fb'; // Veerabhadra T M

    await supabase.from('users').update({
        comp_off_opening_balance: 5.0,
        comp_off_opening_date: '2026-07-01',
        updated_at: new Date().toISOString()
    }).eq('id', userId);

    console.log("Updated Veerabhadra T M: comp_off_opening_balance = 5.0, comp_off_opening_date = '2026-07-01'");
}

setExact35().catch(console.error);
