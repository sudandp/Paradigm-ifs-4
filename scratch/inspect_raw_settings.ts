...
async function main() {
    ...
    if (error) {
        ...
        // Save the raw settings to a file
        fs.writeFileSync('scratch/raw_settings.json', JSON.stringify(settings, null, 2));
        console.log("Raw settings successfully saved to scratch/raw_settings.json");
    }
}
