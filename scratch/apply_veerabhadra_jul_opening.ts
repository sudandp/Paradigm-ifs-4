...
async function testJulOpening() {
    const userId = '216d264d-b20b-45a1-91b5-09cb47c781fb'; // Veerabhadra T M

    // Update user opening balance to 3.5 starting 2026-07-01
    ...
    console.log("Updated Veerabhadra T M: comp_off_opening_balance = 3.5, comp_off_opening_date = '2026-07-01'");
}

testJulOpening().catch(console.error);
