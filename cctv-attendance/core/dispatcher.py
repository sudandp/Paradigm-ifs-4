...
class EventDispatcher:
    ...
    async def _get_tunnel_public_url(self) -> Optional[str]:
        """Auto-detect the active public HTTPS tunnel URL (Cloudflare Tunnel, Ngrok, or .env).
        
        Priority:
        1. TUNNEL_URL or CLOUDFLARE_URL from .env / environment variables
        2. tunnel_url.txt file (written by cloudflare runner script)
        ...
        # 2. Check tunnel_url.txt if generated by cloudflare runner
        try:
